...
function books_theme_name_scripts() {
    wp_enqueue_style( 'book-plugin-css', WP_PLUGIN_DIR . '/library-book-search/search-book.css');
...
add_action( 'wp_enqueue_scripts', 'books_theme_name_scripts' );
